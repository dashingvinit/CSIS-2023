...
const Hero = () => (
  <>
    <section
      id="home"
      className={`flex md:flex-row flex-col md:justify-center items-center ${styles.paddingY}`}>
      ...
      <div
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="font-poppins font-semibold ss:text-[72px] text-[42px] text-white ss:leading-[90px] leading-[65px] ss:-z-10 red-text-gradient">
